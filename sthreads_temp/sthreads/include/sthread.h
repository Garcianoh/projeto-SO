 ...
 * Create a new thread starting at the routine given, which will
 * be passed arg. The new thread does not necessarily execute immediatly.
 * The 'priority' parameter sets the initial static priority (0-14).
 */
...
/*
 * Ajusta o valor nice da thread atual e retorna a nova prioridade calculada para o próximo epoch.
 * O valor nice afeta a prioridade dinâmica da thread, permitindo ao usuário influenciar o escalonamento.
 */
